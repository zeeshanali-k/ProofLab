...
export default function CirculatoryPage() {
	const system = SYSTEM_CONTENT.circulatory;
	return (
		<main className="bio-page">
			...
			<div className="bio-systems-layout">
				<div className="bio-systems-diagram"><SystemDiagram2D systemId="circulatory" /></div>
