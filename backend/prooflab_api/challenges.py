...
INEQUALITY_CONSTRAINTS = ("Use one of <, ≤, >, or ≥.", "Submit the final solution region in x.")
DERIVATIVE_CONSTRAINTS = ("Use first-derivative notation: f'(x) = ….", "Use the supported polynomial and trig notation.")
ANTIDERIVATIVE_CONSTRAINTS = ("Use F(x) = … + C.", "The constant of integration is required.")
